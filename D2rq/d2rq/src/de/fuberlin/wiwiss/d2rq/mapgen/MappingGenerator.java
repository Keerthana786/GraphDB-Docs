...
public class MappingGenerator {
	...
	public boolean isLinkTable(RelationName tableName) {
		...
		while (it.hasNext()) {
			Join fk = it.next();
			if(tableName.toString().equals("film_actor")){
			System.err.println(fk.toString());
			}
...
// 		if(tableName.toString().equals("actor")){
// 		StmtIterator iter = this.vocabModel.listStatements();
...
//     System.err.print(subject.toString()+"\t\t");
//     System.err.print(" " + predicate.toString() + " \t\t");
